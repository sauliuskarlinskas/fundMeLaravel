                ...
                <form method="post" action="{{ route('ideas-addmoney', $idea) }}">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <label>Select an amount</label>
                            <div>
                                <button type="button" class="btn btn-outline-primary" onclick="updateAmount(10)">10 €</button>
                                <button type="button" class="btn btn-outline-primary" onclick="updateAmount(20)">20 €</button>
                                <button type="button" class="btn btn-outline-primary" onclick="updateAmount(50)">50 €</button>
                                <button type="button" class="btn btn-outline-primary" onclick="updateAmount(100)">100 €</button>
                            </div>
